...
*																							*
* File Name                   : GetServiceCodeTag.java                                      *
* Author                      : Anantaraj S                                                 *
* Creation Date               : 06-Aug-2008                                                 *
* Description                 : This file gives auto generated service code                 *
*                                                                                           *
...
/**
 * Tag hander class which gets service code
 *
 */
public class GetServiceCodeTag extends BaseJSTLTag {
    /**
	 * 
	 */
     ...
     */
    static Logger logger = Logger.getLogger(GetServiceCodeTag.class);
    /**
