 ...
 *																							*
 * File Name                   : ServiceBureauBean.java                                      *
...
public class ServiceBureauBean extends ActionForm
{
	...
	addressLine1,addressLine2,addressLine3,addressLine4,telephoneNo1,telephoneNo2,
	pinCode,country,companyName,patuId,keyKEK,keyAUK,createdOn,createdBy,lastUpdatedBy,lastUpdatedOn,status,reopen,
	keyKEKPart1,keyKEKPart2,keyKVV,generationNumber,generationDate,keyPart1,keyPart2,keyExpireDate,kekStatus,controlCode,
	authorizedOn,authorizedBy;
	...
	private Date parseDate(String dt)
	{
		...
		{
			System.out.println("Date Parse Exception in Bean");
		}
		return parsedDate;
	}
