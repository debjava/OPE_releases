...
<title class="hideonprint"><fmt:message key="kek_part_1"/></title>
...
<div class="popup"><span class="popup_shadow">
	<div class="popup_title" ><span class="popup_text"><fmt:message key="kek_part_1"/></span></span></div></span>
</div>
	...
	<tr>
		<td>
			<fieldset class="fieldset">
				<table cellpadding="4" cellspacing="4" width="100%">				
				<tr>
					<td  valign="top"><p class="label_normal"><fmt:message key="customers_name"/>: <c:out value="${requestScope.customerName1}"/></p></td>
				</tr>
			...
			<tr>
				...
				<tr id="print" class="hideonscreen">
					<td  valign="top" class="hideonscreen"><p class="label_normal"><fmt:message key="part_1_of_kek"/>: <strong><c:out value="${requestScope.keyKEKPart1}"/></strong></p></td>
				</tr>
