...
public class GenericCommandProcessor implements CommandProcessor {
  ...
  {
	  System.out.println("GenericCommandProcessor : execute - command execution");
    //Execute command
    Reply reply;
    
    System.out.println("GenericCommandProcessor : execute - Command Name-------"+command.getName());
    ...
    System.out.println("GenericCommandProcessor : execute - debug - "+debug);
  ...
  {
	  System.out.println("GenericCommandProcessor : getFileSystemReply - e.getMessage() - "+e.getMessage());
	  System.out.println("GenericCommandProcessor : getFileSystemReply - e.getText() - "+e.getText());
