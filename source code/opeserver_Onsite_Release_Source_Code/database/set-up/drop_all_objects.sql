...
PROMPT 5] Connect to Closed Workflow Schema
PROMPT 6] Exit
PROMPT
...
select DECODE(LOWER('&pm_op_inst_opt'),'4','pm_clean_open',
                 		 '2',	'pm_uninstall',
                 		 '1',	'pm_install',
                 		 '3',	'pm_recompile',
                 		 '5',	'pmconn_closed',
...
select DECODE('&next_script','pm_install','I N S T A L L I N G  ProcessMate ... ',
                 'pm_uninstall','U N I N S T A L L I N G  ProcessMate ... ',
                 'pm_clean_open','C L E A N I N G  ProcessMate Open Workflow Schema ...',
                 'pm_recompile', 'R E C O M P I L I N G Processmate ...',
